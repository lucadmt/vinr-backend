...
public class CorsConfig {
    ...
    private static final String ALLOWED_HEADERS = "x-requested-with, access-control-allow-origin, authorization, Content-Type, Content-Length, Authorization, credential, X-XSRF-TOKEN";
